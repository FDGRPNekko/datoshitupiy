...
REPO_URL="https://github.com/FDGRPNekko/datoshitupiy.git"
PROJECT_DIR="datoshitupiy"
NGINX_CONF_FILE="/etc/nginx/sites-available/${PROJECT_DIR}.conf"

echo -e "${GREEN}--- Ты заебал, отпусти меня спать ---${NC}"
...
read_input "Введите ваш домен (например, иди-нахуй.рф): " USER_INPUT_DOMAIN
...
echo -e "\n\n${GREEN}=====================================================${NC}"
echo -e "${GREEN}      Всё нах, ебись сам       ${NC}"
echo -e "${GREEN}=====================================================${NC}"
echo -e "\nВеб-панель доступна по влагалищу:"
echo -e "  - ${YELLOW}https://${DOMAIN}:${YOOKASSA_PORT}/login${NC}"
echo -e "\nДанные для первого входа во влагалище:"
echo -e "  - Логин:   ${CYAN}admin${NC}"
echo -e "  - Пароль:  ${CYAN}admin${NC}"
echo -e "\n${RED}ПЕРВЫЕ ШАГИ:${NC}"
echo -e "1. Войдите в панель и ${RED}сразу же засунь хуй в пиздуь${NC}."
echo -e "2. На странице 'Настройки' введите ваш размер хуя"
echo -e "3. Нажмите 'Сохранить' и затем 'Трахнуть Бота'."
echo -e "\n${CYAN}Не забудьте указать URL для траха вебхуков в YooKassa:${NC}"
